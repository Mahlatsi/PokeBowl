...
import com.pokebowl.pokeapiandroid.databinding.ListItemPokemonBinding
import com.pokebowl.pokeapiandroid.model.PokemonResult
import com.pokebowl.pokeapiandroid.utils.NETWORK_VIEW_TYPE
import com.pokebowl.pokeapiandroid.utils.PRODUCT_VIEW_TYPE
import com.pokebowl.pokeapiandroid.utils.getPicUrl
...
class PokemonAdapter(private val navigate: (PokemonResult, Int, String?) -> Unit) :
                        ...
                        override fun onResourceReady(resource: Drawable?, model: Any?, target: Target<Drawable>?, dataSource: DataSource?, isFirstResource: Boolean): Boolean {
                            ...
                            Palette.Builder(bitmap).generate {
                                it?.let { palette ->
                                    ...
                                    pokemonItemTitle.setBackgroundColor(dominantColor)
                                }
                            }
                            progressCircular.isVisible = false
                            return false
    ...
    private class PokemonDiffCallback : DiffUtil.ItemCallback<PokemonResult>() {
        override fun areItemsTheSame(oldItem: PokemonResult, newItem: PokemonResult): Boolean = oldItem == newItem

        override fun areContentsTheSame(oldItem: PokemonResult, newItem: PokemonResult): Boolean = oldItem == newItem
    }
