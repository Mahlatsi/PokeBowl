...
import com.pokebowl.pokeapiandroid.databinding.NetworkStateItemBinding
...
class LoadingStateAdapter(private val retry: () -> Unit) :
    ...
    class LoadStateViewHolder(val binding: NetworkStateItemBinding) : RecyclerView.ViewHolder(binding.root)
}